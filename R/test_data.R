...
#' \describe{
#'   \item{FC_rank}{contains fold-change based sequence ranks from 20 liver cancer patients. Rownames matches original mRNA expression matrix.}
#'   \item{motif_probs}{contains sequence-specific motif probabilities for each 3' UTR sequence (from protein-coding genes). The matrix contains information on two motifs; the miR-122-5p target site ("ACACTCC"; known to be present in liver tissue) and the non-functional reverse-complementary motif ("GGAGTGT").}
